                            ...
                            <SlideToggle collapsed={ true }>
                                {
                                    ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <li className={ path.indexOf( "categories/" ) > -1 ? 'active' : '' }>
                                            <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Categories
                            ...
                            <SlideToggle collapsed={ true }>
                                {
                                    ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <li className={ path.indexOf( "products/" ) > -1 ? 'active' : '' }>
                                            <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Products
                                            <span className="mmenu-btn"></span>
                                            </Link>
                                            <ul ref={ setCollapsibleElement }>
                                                <SlideToggle collapsed={ true }>
                            ...
                            <SlideToggle collapsed={ true }>
                                {
                                    ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <li className={ `sf-with-ul ${ path.indexOf( "pages/" ) > -1 ? 'active' : '' }` }>
                                            <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Pages
                                                <span className="mmenu-btn"></span>
                                            </Link>
                                            <ul ref={ setCollapsibleElement }>
