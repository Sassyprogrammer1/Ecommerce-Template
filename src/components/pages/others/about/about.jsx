                                        ...
                                        <SlideToggle collapsed={ false }>
                                            {
                                                ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                    <div className="history-item overflow-hidden">

                                                        <div className="history-header" id="historyOne">
                                                            <h5>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ `h-auto ${toggleState.toLowerCase()}` }>2000</Link>
                                                            </h5>
                                                        </div>
                                        ...
                                        <SlideToggle collapsed={ true }>
                                            {
                                                ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                    <div className="history-item overflow-hidden">
                                                        ...
                                                        <div className="history-header" id="historyOne">
                                                            <h5>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ `h-auto ${toggleState.toLowerCase()}` }>2005</Link>
                                                            </h5>
                                                        </div>
                                        ...
                                        <SlideToggle collapsed={ true }>
                                            {
                                                ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                    <div className="history-item overflow-hidden">
                                                        ...
                                                        <div className="history-header" id="historyOne">
                                                            <h5>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ `h-auto ${toggleState.toLowerCase()}` }>2010</Link>
                                                            </h5>
                                                        </div>
                                        ...
                                        <SlideToggle collapsed={ true }>
                                            {
                                                ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                    <div className="history-item overflow-hidden">
                                                        ...
                                                        <div className="history-header" id="historyOne">
                                                            <h5>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ `h-auto ${toggleState.toLowerCase()}` }>2015</Link>
                                                            </h5>
                                                        </div>
                                        ...
                                        <SlideToggle collapsed={ true }>
                                            {
                                                ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                    <div className="history-item overflow-hidden">
                                                        ...
                                                        <div className="history-header" id="historyOne">
                                                            <h5>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ `h-auto ${toggleState.toLowerCase()}` }>2018</Link>
                                                            </h5>
                                                        </div>
